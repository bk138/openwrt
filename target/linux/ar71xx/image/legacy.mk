...
emr3000_mtdlayout=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,64k(art)ro,1408k(kernel),30656k(rootfs),320k(config)ro,32064k@0x60000(firmware)
...
$(eval $(call SingleProfile,EnGenius,64k,EMR3000,emr3000,EMR3000,ttyS0,115200,$$(emr3000_mtdlayout),KRuImage,,0x83))
